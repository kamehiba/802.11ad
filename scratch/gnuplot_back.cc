...
void isAssociated(Ptr<Node> node, bool m_isAssociated);

bool m_isAssociated	= false;
...
/////////////////////////////////////////////////////
	...
	else
	{
		...
		Simulator::Schedule(Seconds(1), &isAssociated, wifiStaNode.Get(0), m_isAssociated);
	}
