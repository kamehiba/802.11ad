...
/////////////////////////////////////////////////////
	...
	NS_LOG_UNCOND ("Installing wifiApNode1");
	MobilityHelper enbMobility1;
	Ptr<ListPositionAllocator> enbPositionAlloc1 = CreateObject<ListPositionAllocator> ();
	enbPositionAlloc1 = CreateObject<ListPositionAllocator> ();
	enbPositionAlloc1->Add (Vector (0.0, 5.0, 0.0));
	enbMobility1.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
	enbMobility1.SetPositionAllocator(enbPositionAlloc1);
	enbMobility1.Install(wifiApNode.Get(0));
	BuildingsHelper::Install (wifiApNode.Get(0));

	NS_LOG_UNCOND ("Installing wifiApNode2");
	MobilityHelper enbMobility2;
	Ptr<ListPositionAllocator> enbPositionAlloc2 = CreateObject<ListPositionAllocator> ();
	enbPositionAlloc2 = CreateObject<ListPositionAllocator> ();
	enbPositionAlloc2->Add (Vector (30.0, 5.0, 0.0));
	enbMobility2.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
	enbMobility2.SetPositionAllocator(enbPositionAlloc2);
	enbMobility2.Install(wifiApNode.Get(1));
	BuildingsHelper::Install (wifiApNode.Get(1));

//    NS_LOG_UNCOND ("Installing mobility on ueNodes");
//    MobilityHelper ueMobility;
//    ueMobility.SetMobilityModel ("ns3::ConstantVelocityMobilityModel");
//    ueMobility.Install (wifiStatNode);
//    wifiStatNode.Get (0)->GetObject<MobilityModel> ()->SetPosition (Vector (-10.0, 10.0, 0.0));
//    wifiStatNode.Get (0)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (ueSpeed, 0, 0));
