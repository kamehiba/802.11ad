...
///////////////////////////////////////////////
	...
	NS_ASSERT (nApoints > 0 && nApoints <= 3);
	NS_ASSERT (nStations > 0 && nStations <= 7);
				...
				NetDeviceContainer staDevs, NetDeviceContainer enbDevs)
{
	...
	startSink(appSourceLTE, 	appSinkLTE, 	onOffHelperLTE, 	remoteHostContainerLte.Get(0), 		appStartTime, 5.0);
	startSink(appSourceWifi, 	appSinkWifi, 	onOffHelperWifi, 	remoteHostContainerWifi.Get(2), 	5.0, 16.0);

	startLteEpsBearer(lteHelper, staDevs.Get(0));
	startSink(appSourceLTE, 	appSinkLTE, 	onOffHelperLTE, 	remoteHostContainerLte.Get(0), 		16.0, 29.0);
	startSink(appSourceWifi, 	appSinkWifi, 	onOffHelperWifi, 	remoteHostContainerWifi.Get(0), 	29.0, 41.0);


	startLteEpsBearer(lteHelper, staDevs.Get(0));
	startSink(appSourceLTE, 	appSinkLTE, 	onOffHelperLTE, 	remoteHostContainerLte.Get(0), 		41.0, 54.0);
	startSink(appSourceWifi, 	appSinkWifi, 	onOffHelperWifi, 	remoteHostContainerWifi.Get(1), 	54.0, 66.0);

	startLteEpsBearer(lteHelper, staDevs.Get(0));
	startSink(appSourceLTE, 	appSinkLTE, 	onOffHelperLTE, 	remoteHostContainerLte.Get(0), 		66.0, simulationTime);


	lteHelper->HandoverRequest (Seconds (16.0), staDevs.Get (0), enbDevs.Get (0), enbDevs.Get (1));
	lteHelper->HandoverRequest (Seconds (41.0), staDevs.Get (0), enbDevs.Get (1), enbDevs.Get (2));
	lteHelper->HandoverRequest (Seconds (66.0), staDevs.Get (1), enbDevs.Get (2), enbDevs.Get (2));
